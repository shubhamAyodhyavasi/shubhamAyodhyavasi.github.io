...
const PROJECTS = [
  ...
  },
  {
    ...
    solution: 'Implemented schema-per-tenant isolation with connection pooling and query optimization.',
  ...
  },
  {
    ...
    description:
      'Automated AWS resource right-sizing and scheduling tool for DevOps teams.',
    problem: '$50K/month wasted on over-provisioned EC2 instances and unused resources.',
    solution: 'Built ML-based usage prediction with automated scaling policies and resource tagging.',
  ...
  },
  {
    ...
    solution: 'Designed Redis cluster with consistent hashing, TTL strategies, and write-through caching.',
...
const ProjectCard = ({ project }) => (
  <motion.div
    ...
    className="group relative bg-slate-800/50 rounded-2xl border border-slate-700/50 hover:border-indigo-500/50 overflow-hidden transition-all duration-300 flex flex-col"
  ...
  >
    ...
    <div className="p-6 flex flex-col flex-1">
      ...
      <div className="flex gap-3">
        <motion.a
          href={project.github}
          className="flex items-center gap-1.5 px-4 py-2 rounded-lg bg-slate-700 hover:bg-slate-600 text-slate-300 hover:text-white text-sm font-medium transition-all"
    ...
    <section id="projects" className="py-24 bg-slate-950">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <h2 className="mt-2 text-3xl sm:text-4xl font-extrabold text-white">Featured Projects</h2>
