...
const SKILLS = [
  ...
  { category: 'Cloud & Infra', items: ['AWS (ECS, Lambda, RDS, S3)', 'Kubernetes', 'Docker', 'Terraform'] },
  { category: 'Databases', items: ['PostgreSQL', 'MySQL', 'Redis', 'MongoDB', 'Elasticsearch'] },
  { category: 'Architecture', items: ['Microservices', 'Event-Driven', 'REST', 'GraphQL', 'gRPC'] },
];
  ...
  return (
    <section id="about" className="py-24 bg-slate-900">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        >
          <span className="text-indigo-400 font-mono text-sm tracking-widest uppercase">Who I Am</span>
